...
export default function VehicleDetail() {
  ...
  // --- NOVA LÓGICA DE ALUGUEL SISTEMÁTICO ---
  const handleRentNow = async () => {
    try {
      // 1. Salva no Carrinho Local (Como já fazia)
      ...
      // 2. REGISTRA A VENDA NO BACKEND PARA O GRÁFICO
      // Enviamos os dados necessários para o SalesStats contabilizar
      const saleData = {
      ...
      // 3. Atualiza o estado visual
      setIsAdded(true);
    } catch (error) {
      console.error("Erro ao processar registro de aluguel:", error);
      // Mesmo se o gráfico falhar, adicionamos ao carrinho para não travar o usuário
      setIsAdded(true);
    }
  };
        ...
        <div className="max-w-6xl mx-auto p-4 lg:p-8 animate-in fade-in duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div className="flex flex-col">
              <div className="mb-10">
                <h2 className="text-4xl lg:text-5xl font-black tracking-tighter leading-none mb-1">
                  <span className="bg-gradient-to-r from-gray-700 to-purple-300 bg-clip-text text-transparent uppercase">
                    {vehicle.brand || "Premium Car"}
                  </span>
                </h2>
                <h1 className="text-1xl lg:text-5xl font-black text-gray-900 leading-none tracking-tighter drop-shadow-sm">
                  {vehicle.model}
                </h1>
              </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-baseline gap-2">
                        <span className="text-4xl lg:text-5xl font-black">
                          U$ {Number(vehicle.price_per_hour).toLocaleString('en-US')}
                        </span>
